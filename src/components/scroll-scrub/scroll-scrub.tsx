/* Seam-locked scroll scrub controller. Media time only; never React state. */
  ...
  useEffect(() => {
    ...
    const primeVideo = async (video?: HTMLVideoElement) => {
      ...
      try {
        ...
        // Keep the poster; a later user gesture or seek retries naturally.
      }
    };
    ...
    >
      ...
      <div className="scroll-scrub__story">
        {segments.map((segment) => {
          ...
          /* Le kicker entre dans le titre du premier chapitre : sinon le seul
           * h1 de la page est une phrase d'ambiance qui ne nomme ni le métier
           * ni le pays. */
            ...
            >
              <div className="scroll-scrub__chapter-pin">
                <div className="scroll-scrub__copy">
                  {estPremier ? (
                    <Heading className="scroll-scrub__heading">
                      {scene.kicker ? (
